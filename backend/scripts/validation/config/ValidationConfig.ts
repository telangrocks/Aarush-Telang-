...
export const DEFAULT_VALIDATION_CONFIG: ValidationSlaConfig = {
  maxWorkerLatencyMs: parseInt(process.env.SLA_WORKER_LATENCY_MS || "3500", 10),
  maxDbLatencyMs: parseInt(process.env.SLA_DB_LATENCY_MS || "3500", 10),
  maxExchangeApiLatencyMs: parseInt(process.env.SLA_EXCHANGE_API_LATENCY_MS || "1500", 10),
  maxKlineFetchLatencyMs: parseInt(process.env.SLA_KLINE_FETCH_LATENCY_MS || "1500", 10),
  ...
  maxOrderExecutionLatencyMs: parseInt(process.env.SLA_ORDER_EXEC_LATENCY_MS || "1500", 10),
  maxRecoveryLatencyMs: parseInt(process.env.SLA_RECOVERY_LATENCY_MS || "1000", 10),
  maxNotificationLatencyMs: parseInt(process.env.SLA_NOTIFICATION_LATENCY_MS || "1000", 10),
  maxClockDriftMs: parseInt(process.env.SLA_MAX_CLOCK_DRIFT_MS || "1000", 10),
